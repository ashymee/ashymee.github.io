...
const Details = () => {
  ...
  return (
    <div className=''>
      <div className='divider'>{t('detail')}</div>
      <div className='space-y-3'>
        {/* fullname */}
        <div className=''>
          <div className='text-xl'>{t('nama_lengkap')}:</div>
          <div className='text-2xl'>Aswin Himawan</div>
        </div>
        {/* email */}
        <div className=''>
          <div className='text-xl flex items-center label-link'>
            <div className='mr-5'>{t('surel')}:</div>
            <a
        ...
        <div className=''>
          <div className='text-xl w-32 flex items-center label-link'>
            <div className='mr-5'>{t('alamat')}:</div>
            <a
        ...
        <div className=''>
          <div className='text-xl w-32 flex items-center label-link'>
            <div className='mr-5'>{t('domisili')}:</div>
            <a
